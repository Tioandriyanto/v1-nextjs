        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-8 relative">
              ...
              {[
                {
                  company: "Kementrian Imigrasi dan Pemasyarakatan Semarang",
                  position: "Internship Website Developer",
                  period: "Juny 2025 – August 2025",
                  description:
                    "During my internship at the Immigration Office (Kantor Imigrasi Kelas I Khusus TPI Semarang), I collaborated with a team to develop a web-based warehouse information system (E-Gudang) to support the management of goods in and out of the office efficiently.",
                },
                {
